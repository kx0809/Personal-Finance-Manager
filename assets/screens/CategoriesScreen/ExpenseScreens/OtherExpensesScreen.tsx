...
const OtherExpensesScreen = () => {
  ...
  const fetchOtherExpensesData = useCallback(async () => {
    try {
      ...
      // Group other expenses data by date
      const groupedData = otherExpensesData.reduce((groups: any, item: any) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.footer}>
        <Text style={styles.totalAmountLabel}>Total Other Expenses:</Text>
